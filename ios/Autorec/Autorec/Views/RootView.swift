...
private struct LivePlaceholderView: View {
    var body: some View { ComingSoonView(title: "ライブ視聴") }
}
...
private struct RecordingsPlaceholderView: View {
    var body: some View { ComingSoonView(title: "録画") }
}
